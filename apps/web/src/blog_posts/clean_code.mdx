---
title: "Clean code"
description: "As an experienced software developer or even if you are a junior developer you have sometimes heard the term clean code and that we should aim to write clean code when we develop. What is clean code and why is it important to write clean code? Do developers follow all their rules from the famous book Clean code by Robert C. Martin. In this article, I will write about my thoughts what are clean code and my experience is what other developers think about clean code."
date: "2023-01-15"
updated: "2023-01-15"
time: "8min"
...
As an experienced software developer or even if you are a junior developer you have sometimes heard the term _clean code_ and that we should aim to write clean code when we develop.
What is clean code and why is it important to write clean code?
Do developers follow all their rules from the famous book [Clean code](https://www.oreilly.com/library/view/clean-code-a/9780136083238/) by _Robert C. Martin_.
In this article, I will write about my thoughts
what are clean code and my experience is what other developers think about clean code.

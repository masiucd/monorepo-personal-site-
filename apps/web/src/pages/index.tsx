    ...
    <Page>
      <section className="bg-hero dark:bg-hero-dark bg-cover flex flex-col justify-center min-h-[25rem]">
        <h1 className="text-4xl pl-4 md:text-6xl md:p-0">
          HI I{" "}
          <span className="border-b-2 dark:border-white border-slate-900">
            am
          </span>{" "}
          {matches ? "Marcell Ciszek Druzynski" : "Marcell.C.D"}
        </h1>
        <aside className="grid grid-cols-5 pr-2 md:pr-0 mb-5">
          <p className="border-l-2 border-slate-900 dark:border-white pl-4 col-start-2 col-end-6 md:text-lg">
            Here where I share my thoughts about software development and topics
            like{" "}
            <span className="text-blue-600  dark:text-blue-500">React</span>,{" "}
            <span className="text-blue-600 dark:text-blue-500">Javascript</span>
            , <span className="text-blue-600 dark:text-blue-500">Go</span> and
